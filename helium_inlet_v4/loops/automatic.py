...
def get_trap_temp(trap_id: str) -> float:
    """
    Fetches numerical trap temperature from state.telemetry_data using exact IO loop keys.
    ...
    for key in keys:
        ...
        # Bypasses None (open circuits/timeouts) and returns valid numeric readings
