...
def run_io_loop():
    ...
    while True:
        ...
        if len(v_vals) >= 6:
            ...
            _, p115_str = Agilent34970A.calc_chamber_aim_sl_pressure(v_vals[2])
            state.telemetry_data["ch115_p"] = p115_str
            state.telemetry_data["ch115_v"] = Agilent34970A.format_voltage(v_vals[2])

            _, p116_str = Agilent34970A.calc_trap_penning_pressure(v_vals[3])
            ...
            _, p119_str = Agilent34970A.calc_convectron_375_pressure(v_vals[5])
